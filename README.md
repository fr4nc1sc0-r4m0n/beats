...
[libbeat](https://github.com/elastic/beats/tree/9.8/libbeat), our Go
framework for creating Beats, and all the officially supported Beats:

Beat  | Description
--- | ---
[Auditbeat](https://github.com/elastic/beats/tree/9.8/auditbeat) | Collect your Linux audit framework data and monitor the integrity of your files.
[Filebeat](https://github.com/elastic/beats/tree/9.8/filebeat) | Tails and ships log files
[Heartbeat](https://github.com/elastic/beats/tree/9.8/heartbeat) | Ping remote services for availability
[Metricbeat](https://github.com/elastic/beats/tree/9.8/metricbeat) | Fetches sets of metrics from the operating system and services
[Packetbeat](https://github.com/elastic/beats/tree/9.8/packetbeat) | Monitors the network and applications by sniffing packets
[Winlogbeat](https://github.com/elastic/beats/tree/9.8/winlogbeat) | Fetches and ships Windows Event logs
[Osquerybeat](https://github.com/elastic/beats/tree/9.8/x-pack/osquerybeat) | Runs Osquery and manages interaction with it.
